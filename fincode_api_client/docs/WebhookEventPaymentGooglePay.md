# FincodeApiClient::WebhookEventPaymentGooglePay
...
| **error_code** | **String** | この決済において発生したエラーのうち、一番最新のエラーのエラーコードです。\\ [各エラーコードの定義はこちらを参照](/develop_support/error)して確認できます。  | [optional] |
...
instance = FincodeApiClient::WebhookEventPaymentGooglePay.new(
  shop_id: s_***********,
  order_id: o_**********************,
  access_id: a_**********************,
  pay_type: null,
