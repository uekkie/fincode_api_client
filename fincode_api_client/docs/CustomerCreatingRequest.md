# FincodeApiClient::CustomerCreatingRequest

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **id** | **String** | 顧客ID\\ 任意の値を指定できます。指定しない場合はfincodeが自動的に生成します。\\ 一度fincodeに登録された顧客IDは削除後も利用できません。  | [optional] |
...
instance = FincodeApiClient::CustomerCreatingRequest.new(
  id: c_**********************,
  name: John Doe,
