# FincodeApiClient::PaymentGooglePayExecutingRequest
...
| **token** | **String** | Google Pay カードトークン\\ Google Payを利用するデバイスから取得したトークン（&#x60;paymentMethodData.tokenizationData.token&#x60;）をBase64エンコードした値を設定します。    トークン生成時、&#x60;tokenizationSpecification&#x60;には以下の値を指定してください。 - gateway： &#x60;fincode&#x60; - gatewayMerchantId： &#x60;{{ショップID}}&#x60;&lt;br&gt;（例：s_01234567890）  詳細は[Docs &gt; 決済処理を実行する（Google Pay）](/payment/googlepay/execution)または[Google Pay ウェブ デベロッパー向けドキュメント](https://developers.google.com/pay/api/web?hl&#x3D;ja)（Google公式）を参照してください。  |  |
...
instance = FincodeApiClient::PaymentGooglePayExecutingRequest.new(
  pay_type: null,
  access_id: a_**********************,
  token: &#x3D;,
  customer_id: c_**********************,
  method: null,
  pay_times: null,
