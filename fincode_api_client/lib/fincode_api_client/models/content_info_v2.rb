...
module FincodeApiClient
  class ContentInfoV2 < ApiModelBase
    # 商材1 名称 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::ContentInfoV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::ContentInfoV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @content1_name.to_s.length < 1
        invalid_properties.push('invalid value for "content1_name", the character length must be greater than or equal to 1.')
      end
      ...
      if @content1_description.to_s.length < 1
        invalid_properties.push('invalid value for "content1_description", the character length must be greater than or equal to 1.')
      end
      ...
      if !@content2_name.nil? && @content2_name.to_s.length < 1
        invalid_properties.push('invalid value for "content2_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@content2_description.nil? && @content2_description.to_s.length < 1
        invalid_properties.push('invalid value for "content2_description", the character length must be greater than or equal to 1.')
      end
      ...
      if !@content3_name.nil? && @content3_name.to_s.length < 1
        invalid_properties.push('invalid value for "content3_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@content3_description.nil? && @content3_description.to_s.length < 1
        invalid_properties.push('invalid value for "content3_description", the character length must be greater than or equal to 1.')
      end
    ...
    def content1_name=(content1_name)
      ...
      if content1_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "content1_name", the character length must be greater than or equal to 1.'
      end
    ...
    def content1_description=(content1_description)
      ...
      if content1_description.to_s.length < 1
        fail ArgumentError, 'invalid value for "content1_description", the character length must be greater than or equal to 1.'
      end
    ...
    def content2_name=(content2_name)
      ...
      if content2_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "content2_name", the character length must be greater than or equal to 1.'
      end
    ...
    def content2_description=(content2_description)
      ...
      if content2_description.to_s.length < 1
        fail ArgumentError, 'invalid value for "content2_description", the character length must be greater than or equal to 1.'
      end
    ...
    def content3_name=(content3_name)
      ...
      if content3_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "content3_name", the character length must be greater than or equal to 1.'
      end
    ...
    def content3_description=(content3_description)
      ...
      if content3_description.to_s.length < 1
        fail ArgumentError, 'invalid value for "content3_description", the character length must be greater than or equal to 1.'
      end
    ...
    def hash
      [content1_name, content1_description, content1_unit_price, content2_name, content2_description, content2_unit_price, content3_name, content3_description, content3_unit_price].hash
    end
