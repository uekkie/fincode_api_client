  ...
  class PaymentVirtualAccountCreatingRequest
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PaymentVirtualAccountCreatingRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @billing_amount.to_s.length < 1
        invalid_properties.push('invalid value for "billing_amount", the character length must be great than or equal to 1.')
      end
      ...
      if !@billing_tax.nil? && @billing_tax.to_s.length < 1
        invalid_properties.push('invalid value for "billing_tax", the character length must be great than or equal to 1.')
      end
    ...
    def billing_amount=(billing_amount)
      ...
      if billing_amount.to_s.length < 1
        fail ArgumentError, 'invalid value for "billing_amount", the character length must be great than or equal to 1.'
      end
    ...
    def billing_tax=(billing_tax)
      ...
      if !billing_tax.nil? && billing_tax.to_s.length < 1
        fail ArgumentError, 'invalid value for "billing_tax", the character length must be great than or equal to 1.'
      end
