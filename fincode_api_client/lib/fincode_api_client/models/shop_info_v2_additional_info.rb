...
module FincodeApiClient
  ...
  class ShopInfoV2AdditionalInfo < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::ShopInfoV2AdditionalInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @shop_how_to_pay.to_s.length < 1
        invalid_properties.push('invalid value for "shop_how_to_pay", the character length must be greater than or equal to 1.')
      end
      ...
      if @shop_product_delivery_time.to_s.length < 1
        invalid_properties.push('invalid value for "shop_product_delivery_time", the character length must be greater than or equal to 1.')
      end
    ...
    def shop_how_to_pay=(shop_how_to_pay)
      ...
      if !shop_how_to_pay.nil? && shop_how_to_pay.to_s.length < 1
        fail ArgumentError, 'invalid value for "shop_how_to_pay", the character length must be greater than or equal to 1.'
      end
    ...
    def shop_product_delivery_time=(shop_product_delivery_time)
      ...
      if !shop_product_delivery_time.nil? && shop_product_delivery_time.to_s.length < 1
        fail ArgumentError, 'invalid value for "shop_product_delivery_time", the character length must be greater than or equal to 1.'
      end
