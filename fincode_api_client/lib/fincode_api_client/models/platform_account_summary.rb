...
module FincodeApiClient
  class PlatformAccountSummary < ApiModelBase
    # プラットフォーム利用料収入サマリーID 
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PlatformAccountSummary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@tenant_shop_id.nil? && @tenant_shop_id.to_s.length < 13
        invalid_properties.push('invalid value for "tenant_shop_id", the character length must be greater than or equal to 13.')
      end
      ...
      if !@tenant_shop_name.nil? && @tenant_shop_name.to_s.length < 1
        invalid_properties.push('invalid value for "tenant_shop_name", the character length must be greater than or equal to 1.')
      end
    ...
    def tenant_shop_id=(tenant_shop_id)
      ...
      if tenant_shop_id.to_s.length < 13
        fail ArgumentError, 'invalid value for "tenant_shop_id", the character length must be greater than or equal to 13.'
      end
    ...
    def tenant_shop_name=(tenant_shop_name)
      ...
      if !tenant_shop_name.nil? && tenant_shop_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "tenant_shop_name", the character length must be greater than or equal to 1.'
      end
