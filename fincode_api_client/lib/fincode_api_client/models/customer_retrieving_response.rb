...
module FincodeApiClient
  class CustomerRetrievingResponse < ApiModelBase
    # 顧客ID 
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::CustomerRetrievingResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::CustomerRetrievingResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@phone_cc.nil? && @phone_cc.to_s.length < 1
        invalid_properties.push('invalid value for "phone_cc", the character length must be greater than or equal to 1.')
      end
      ...
      if !@phone_no.nil? && @phone_no.to_s.length < 1
        invalid_properties.push('invalid value for "phone_no", the character length must be greater than or equal to 1.')
      end
      ...
      if !@addr_country.nil? && @addr_country.to_s.length < 1
        invalid_properties.push('invalid value for "addr_country", the character length must be greater than or equal to 1.')
      end
      ...
      if !@addr_state.nil? && @addr_state.to_s.length < 1
        invalid_properties.push('invalid value for "addr_state", the character length must be greater than or equal to 1.')
      end
      ...
      if !@addr_city.nil? && @addr_city.to_s.length < 1
        invalid_properties.push('invalid value for "addr_city", the character length must be greater than or equal to 1.')
      end
      ...
      if !@addr_line_1.nil? && @addr_line_1.to_s.length < 1
        invalid_properties.push('invalid value for "addr_line_1", the character length must be greater than or equal to 1.')
      end
      ...
      if !@addr_line_2.nil? && @addr_line_2.to_s.length < 1
        invalid_properties.push('invalid value for "addr_line_2", the character length must be greater than or equal to 1.')
      end
      ...
      if !@addr_line_3.nil? && @addr_line_3.to_s.length < 1
        invalid_properties.push('invalid value for "addr_line_3", the character length must be greater than or equal to 1.')
      end
      ...
      if !@addr_post_code.nil? && @addr_post_code.to_s.length < 1
        invalid_properties.push('invalid value for "addr_post_code", the character length must be greater than or equal to 1.')
      end
      ...
      if !@card_registration.nil? && @card_registration.to_s.length < 1
        invalid_properties.push('invalid value for "card_registration", the character length must be greater than or equal to 1.')
      end
      ...
      if !@directdebit_registration.nil? && @directdebit_registration.to_s.length < 1
        invalid_properties.push('invalid value for "directdebit_registration", the character length must be greater than or equal to 1.')
      end
    ...
    def phone_cc=(phone_cc)
      ...
      if !phone_cc.nil? && phone_cc.to_s.length < 1
        fail ArgumentError, 'invalid value for "phone_cc", the character length must be greater than or equal to 1.'
      end
    ...
    def phone_no=(phone_no)
      ...
      if !phone_no.nil? && phone_no.to_s.length < 1
        fail ArgumentError, 'invalid value for "phone_no", the character length must be greater than or equal to 1.'
      end
    ...
    def addr_country=(addr_country)
      ...
      if !addr_country.nil? && addr_country.to_s.length < 1
        fail ArgumentError, 'invalid value for "addr_country", the character length must be greater than or equal to 1.'
      end
    ...
    def addr_state=(addr_state)
      ...
      if !addr_state.nil? && addr_state.to_s.length < 1
        fail ArgumentError, 'invalid value for "addr_state", the character length must be greater than or equal to 1.'
      end
    ...
    def addr_city=(addr_city)
      ...
      if !addr_city.nil? && addr_city.to_s.length < 1
        fail ArgumentError, 'invalid value for "addr_city", the character length must be greater than or equal to 1.'
      end
    ...
    def addr_line_1=(addr_line_1)
      ...
      if !addr_line_1.nil? && addr_line_1.to_s.length < 1
        fail ArgumentError, 'invalid value for "addr_line_1", the character length must be greater than or equal to 1.'
      end
    ...
    def addr_line_2=(addr_line_2)
      ...
      if !addr_line_2.nil? && addr_line_2.to_s.length < 1
        fail ArgumentError, 'invalid value for "addr_line_2", the character length must be greater than or equal to 1.'
      end
    ...
    def addr_line_3=(addr_line_3)
      ...
      if !addr_line_3.nil? && addr_line_3.to_s.length < 1
        fail ArgumentError, 'invalid value for "addr_line_3", the character length must be greater than or equal to 1.'
      end
    ...
    def addr_post_code=(addr_post_code)
      ...
      if !addr_post_code.nil? && addr_post_code.to_s.length < 1
        fail ArgumentError, 'invalid value for "addr_post_code", the character length must be greater than or equal to 1.'
      end
