...
module FincodeApiClient
  class PaymentPayPayChangingAmountResponse < ApiModelBase
    # ショップID 
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PaymentPayPayChangingAmountResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@code_url.nil? && @code_url.to_s.length < 1
        invalid_properties.push('invalid value for "code_url", the character length must be greater than or equal to 1.')
      end
      ...
      if !@store_id.nil? && @store_id.to_s.length < 1
        invalid_properties.push('invalid value for "store_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@code_id.nil? && @code_id.to_s.length < 1
        invalid_properties.push('invalid value for "code_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@payment_id.nil? && @payment_id.to_s.length < 1
        invalid_properties.push('invalid value for "payment_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@paypay_result_code.nil? && @paypay_result_code.to_s.length < 1
        invalid_properties.push('invalid value for "paypay_result_code", the character length must be greater than or equal to 1.')
      end
      ...
      if !@merchant_payment_id.nil? && @merchant_payment_id.to_s.length < 1
        invalid_properties.push('invalid value for "merchant_payment_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@merchant_capture_id.nil? && @merchant_capture_id.to_s.length < 1
        invalid_properties.push('invalid value for "merchant_capture_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@merchant_update_id.nil? && @merchant_update_id.to_s.length < 1
        invalid_properties.push('invalid value for "merchant_update_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@merchant_revert_id.nil? && @merchant_revert_id.to_s.length < 1
        invalid_properties.push('invalid value for "merchant_revert_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@merchant_refund_id.nil? && @merchant_refund_id.to_s.length < 1
        invalid_properties.push('invalid value for "merchant_refund_id", the character length must be greater than or equal to 1.')
      end
    ...
    def code_url=(code_url)
      ...
      if !code_url.nil? && code_url.to_s.length < 1
        fail ArgumentError, 'invalid value for "code_url", the character length must be greater than or equal to 1.'
      end
    ...
    def store_id=(store_id)
      ...
      if !store_id.nil? && store_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "store_id", the character length must be greater than or equal to 1.'
      end
    ...
    def code_id=(code_id)
      ...
      if !code_id.nil? && code_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "code_id", the character length must be greater than or equal to 1.'
      end
    ...
    def payment_id=(payment_id)
      ...
      if !payment_id.nil? && payment_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "payment_id", the character length must be greater than or equal to 1.'
      end
    ...
    def paypay_result_code=(paypay_result_code)
      ...
      if !paypay_result_code.nil? && paypay_result_code.to_s.length < 1
        fail ArgumentError, 'invalid value for "paypay_result_code", the character length must be greater than or equal to 1.'
      end
    ...
    def merchant_payment_id=(merchant_payment_id)
      ...
      if !merchant_payment_id.nil? && merchant_payment_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_payment_id", the character length must be greater than or equal to 1.'
      end
    ...
    def merchant_capture_id=(merchant_capture_id)
      ...
      if !merchant_capture_id.nil? && merchant_capture_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_capture_id", the character length must be greater than or equal to 1.'
      end
    ...
    def merchant_update_id=(merchant_update_id)
      ...
      if !merchant_update_id.nil? && merchant_update_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_update_id", the character length must be greater than or equal to 1.'
      end
    ...
    def merchant_revert_id=(merchant_revert_id)
      ...
      if !merchant_revert_id.nil? && merchant_revert_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_revert_id", the character length must be greater than or equal to 1.'
      end
    ...
    def merchant_refund_id=(merchant_refund_id)
      ...
      if !merchant_refund_id.nil? && merchant_refund_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "merchant_refund_id", the character length must be greater than or equal to 1.'
      end
