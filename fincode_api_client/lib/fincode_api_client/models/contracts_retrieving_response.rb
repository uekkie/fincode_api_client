...
module FincodeApiClient
  class ContractsRetrievingResponse < ApiModelBase
    # ショップID（テナント） 
    ...
    # 本人確認手続き ステータス  入金開始に必要な本人確認手続きのステータスを表します。 - `501`: 入金に必要な手続きが未完了 - `502`: 入金可能 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::ContractsRetrievingResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::ContractsRetrievingResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@stop_cancelaltion_memo.nil? && @stop_cancelaltion_memo.to_s.length < 1
        invalid_properties.push('invalid value for "stop_cancelaltion_memo", the character length must be greater than or equal to 1.')
      end
      ...
      if !@obligations_notice.nil? && @obligations_notice.to_s.length < 1
        invalid_properties.push('invalid value for "obligations_notice", the character length must be greater than or equal to 1.')
      end
      ...
      if !@user_shop_name.nil? && @user_shop_name.to_s.length < 1
        invalid_properties.push('invalid value for "user_shop_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@register_mail.nil? && @register_mail.to_s.length < 1
        invalid_properties.push('invalid value for "register_mail", the character length must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      sales_deposit_status_code_validator = EnumAttributeValidator.new('Integer', [501, 502])
    ...
    def sales_deposit_status_code=(sales_deposit_status_code)
      validator = EnumAttributeValidator.new('Integer', [501, 502])
    ...
    def stop_cancelaltion_memo=(stop_cancelaltion_memo)
      ...
      if !stop_cancelaltion_memo.nil? && stop_cancelaltion_memo.to_s.length < 1
        fail ArgumentError, 'invalid value for "stop_cancelaltion_memo", the character length must be greater than or equal to 1.'
      end
    ...
    def obligations_notice=(obligations_notice)
      ...
      if !obligations_notice.nil? && obligations_notice.to_s.length < 1
        fail ArgumentError, 'invalid value for "obligations_notice", the character length must be greater than or equal to 1.'
      end
    ...
    def user_shop_name=(user_shop_name)
      ...
      if !user_shop_name.nil? && user_shop_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "user_shop_name", the character length must be greater than or equal to 1.'
      end
    ...
    def register_mail=(register_mail)
      ...
      if !register_mail.nil? && register_mail.to_s.length < 1
        fail ArgumentError, 'invalid value for "register_mail", the character length must be greater than or equal to 1.'
      end
