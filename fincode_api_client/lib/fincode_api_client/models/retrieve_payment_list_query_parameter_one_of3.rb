...
module FincodeApiClient
  class RetrievePaymentListQueryParameterOneOf3 < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::RetrievePaymentListQueryParameterOneOf3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@billing_total_amount_min.nil? && @billing_total_amount_min.to_s.length < 1
        invalid_properties.push('invalid value for "billing_total_amount_min", the character length must be greater than or equal to 1.')
      end
      ...
      if !@billing_total_amount_max.nil? && @billing_total_amount_max.to_s.length < 1
        invalid_properties.push('invalid value for "billing_total_amount_max", the character length must be greater than or equal to 1.')
      end
    ...
    def billing_total_amount_min=(billing_total_amount_min)
      ...
      if billing_total_amount_min.to_s.length < 1
        fail ArgumentError, 'invalid value for "billing_total_amount_min", the character length must be greater than or equal to 1.'
      end
    ...
    def billing_total_amount_max=(billing_total_amount_max)
      ...
      if billing_total_amount_max.to_s.length < 1
        fail ArgumentError, 'invalid value for "billing_total_amount_max", the character length must be greater than or equal to 1.'
      end
