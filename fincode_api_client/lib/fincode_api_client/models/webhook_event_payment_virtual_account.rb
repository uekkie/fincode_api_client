...
module FincodeApiClient
  class WebhookEventPaymentVirtualAccount < ApiModelBase
    # ショップID 
    ...
    # 支払期限日数\\ \\ 実行日から見て、支払期限日数後の翌日AMに期限切れになります。\\ 例）2024/4/1に、`支払期限日数=2`で決済実行した場合、2024/4/4 AMに期限切れ 
    ...
    def self.openapi_types
      {
        ...
        :'error_code' => :'String',
        :'overpayment_flag' => :'PropertiesOverpaymentFlag',
        :'cancel_overpayment_flag' => :'PropertiesCancelOverpaymentFlag',
        :'expire_overpayment_flag' => :'ExpireOverpaymentFlag',
        :'event' => :'FincodeEvent'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::WebhookEventPaymentVirtualAccount` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::WebhookEventPaymentVirtualAccount`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@tax.nil? && @tax.to_s.length > 20
        invalid_properties.push('invalid value for "tax", the character length must be smaller than or equal to 20.')
      end
      ...
      if !@va_branch_code.nil? && @va_branch_code.to_s.length < 1
        invalid_properties.push('invalid value for "va_branch_code", the character length must be greater than or equal to 1.')
      end
      ...
      if !@va_account_number.nil? && @va_account_number.to_s.length < 7
        invalid_properties.push('invalid value for "va_account_number", the character length must be greater than or equal to 7.')
      end
      ...
      if !@virtual_account_id.nil? && @virtual_account_id.to_s.length < 10
        invalid_properties.push('invalid value for "virtual_account_id", the character length must be greater than or equal to 10.')
      end
    ...
    def valid?
      ...
      return false if !@tax.nil? && @tax.to_s.length > 20
    ...
    def tax=(tax)
      ...
      if tax.to_s.length > 20
        fail ArgumentError, 'invalid value for "tax", the character length must be smaller than or equal to 20.'
      end
    ...
    def va_branch_code=(va_branch_code)
      ...
      if !va_branch_code.nil? && va_branch_code.to_s.length < 1
        fail ArgumentError, 'invalid value for "va_branch_code", the character length must be greater than or equal to 1.'
      end
    ...
    def va_account_number=(va_account_number)
      ...
      if !va_account_number.nil? && va_account_number.to_s.length < 7
        fail ArgumentError, 'invalid value for "va_account_number", the character length must be greater than or equal to 7.'
      end
    ...
    def virtual_account_id=(virtual_account_id)
      ...
      if !virtual_account_id.nil? && virtual_account_id.to_s.length < 10
        fail ArgumentError, 'invalid value for "virtual_account_id", the character length must be greater than or equal to 10.'
      end
    ...
    def hash
      [shop_id, id, access_id, pay_type, status, customer_group_id, customer_id, process_date, client_field_1, client_field_2, client_field_3, amount, tax, billing_amount, billing_tax, billing_total_amount, payment_term_day, payment_term, payment_method_id, va_branch_code, va_branch_name, va_account_number, va_account_name, account_assignment_date, virtual_account_id, transaction_date, value_date, remitter_bank_name, remitter_branch_name, remitter_account_name, error_code, overpayment_flag, cancel_overpayment_flag, expire_overpayment_flag, event].hash
    end
