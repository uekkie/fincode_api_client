...
module FincodeApiClient
  class InvoiceDetailCancelingResponse < ApiModelBase
    # インボイスID 
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::InvoiceDetailCancelingResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::InvoiceDetailCancelingResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@status.nil? && @status.to_s.length < 1
        invalid_properties.push('invalid value for "status", the character length must be greater than or equal to 1.')
      end
      ...
      if !@invoice_url.nil? && @invoice_url.to_s.length < 1
        invalid_properties.push('invalid value for "invoice_url", the character length must be greater than or equal to 1.')
      end
      ...
      if !@bill_pdf_url.nil? && @bill_pdf_url.to_s.length < 1
        invalid_properties.push('invalid value for "bill_pdf_url", the character length must be greater than or equal to 1.')
      end
      ...
      if !@receipt_pdf_url.nil? && @receipt_pdf_url.to_s.length < 1
        invalid_properties.push('invalid value for "receipt_pdf_url", the character length must be greater than or equal to 1.')
      end
      ...
      if !@customer_honorific.nil? && @customer_honorific.to_s.length < 1
        invalid_properties.push('invalid value for "customer_honorific", the character length must be greater than or equal to 1.')
      end
      ...
      if !@issue_date.nil? && @issue_date.to_s.length < 1
        invalid_properties.push('invalid value for "issue_date", the character length must be greater than or equal to 1.')
      end
    ...
    def status=(status)
      ...
      if status.to_s.length < 1
        fail ArgumentError, 'invalid value for "status", the character length must be greater than or equal to 1.'
      end
    ...
    def invoice_url=(invoice_url)
      ...
      if invoice_url.to_s.length < 1
        fail ArgumentError, 'invalid value for "invoice_url", the character length must be greater than or equal to 1.'
      end
    ...
    def bill_pdf_url=(bill_pdf_url)
      ...
      if bill_pdf_url.to_s.length < 1
        fail ArgumentError, 'invalid value for "bill_pdf_url", the character length must be greater than or equal to 1.'
      end
    ...
    def receipt_pdf_url=(receipt_pdf_url)
      ...
      if receipt_pdf_url.to_s.length < 1
        fail ArgumentError, 'invalid value for "receipt_pdf_url", the character length must be greater than or equal to 1.'
      end
    ...
    def customer_honorific=(customer_honorific)
      ...
      if customer_honorific.to_s.length < 1
        fail ArgumentError, 'invalid value for "customer_honorific", the character length must be greater than or equal to 1.'
      end
    ...
    def issue_date=(issue_date)
      ...
      if issue_date.to_s.length < 1
        fail ArgumentError, 'invalid value for "issue_date", the character length must be greater than or equal to 1.'
      end
