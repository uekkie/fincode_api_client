...
module FincodeApiClient
  class PaymentDirectDebitChangingAmountResponse < ApiModelBase
    # ショップID 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::PaymentDirectDebitChangingAmountResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PaymentDirectDebitChangingAmountResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@branch_code.nil? && @branch_code.to_s.length < 3
        invalid_properties.push('invalid value for "branch_code", the character length must be greater than or equal to 3.')
      end
      ...
      if !@branch_name.nil? && @branch_name.to_s.length < 1
        invalid_properties.push('invalid value for "branch_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@remarks.nil? && @remarks.to_s.length < 1
        invalid_properties.push('invalid value for "remarks", the character length must be greater than or equal to 1.')
      end
    ...
    def branch_code=(branch_code)
      ...
      if !branch_code.nil? && branch_code.to_s.length < 3
        fail ArgumentError, 'invalid value for "branch_code", the character length must be greater than or equal to 3.'
      end
    ...
    def branch_name=(branch_name)
      ...
      if !branch_name.nil? && branch_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "branch_name", the character length must be greater than or equal to 1.'
      end
    ...
    def remarks=(remarks)
      ...
      if !remarks.nil? && remarks.to_s.length < 1
        fail ArgumentError, 'invalid value for "remarks", the character length must be greater than or equal to 1.'
      end
