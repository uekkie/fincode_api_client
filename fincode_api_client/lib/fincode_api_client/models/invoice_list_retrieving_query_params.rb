...
module FincodeApiClient
  class InvoiceListRetrievingQueryParams < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::InvoiceListRetrievingQueryParams` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::InvoiceListRetrievingQueryParams`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@due_date_from.nil? && @due_date_from.to_s.length < 10
        invalid_properties.push('invalid value for "due_date_from", the character length must be greater than or equal to 10.')
      end
      ...
      if !@due_date_to.nil? && @due_date_to.to_s.length < 10
        invalid_properties.push('invalid value for "due_date_to", the character length must be greater than or equal to 10.')
      end
      ...
      if !@issue_date_from.nil? && @issue_date_from.to_s.length < 10
        invalid_properties.push('invalid value for "issue_date_from", the character length must be greater than or equal to 10.')
      end
      ...
      if !@issue_date_to.nil? && @issue_date_to.to_s.length < 10
        invalid_properties.push('invalid value for "issue_date_to", the character length must be greater than or equal to 10.')
      end
      ...
      if !@created_from.nil? && @created_from.to_s.length < 10
        invalid_properties.push('invalid value for "created_from", the character length must be greater than or equal to 10.')
      end
      ...
      if !@created_to.nil? && @created_to.to_s.length < 10
        invalid_properties.push('invalid value for "created_to", the character length must be greater than or equal to 10.')
      end
      ...
      if !@invoice_number.nil? && @invoice_number.to_s.length < 1
        invalid_properties.push('invalid value for "invoice_number", the character length must be greater than or equal to 1.')
      end
      ...
      if !@lines_date_from.nil? && @lines_date_from.to_s.length < 10
        invalid_properties.push('invalid value for "lines_date_from", the character length must be greater than or equal to 10.')
      end
      ...
      if !@lines_date_to.nil? && @lines_date_to.to_s.length < 10
        invalid_properties.push('invalid value for "lines_date_to", the character length must be greater than or equal to 10.')
      end
      ...
      if !@transaction_date_from.nil? && @transaction_date_from.to_s.length < 10
        invalid_properties.push('invalid value for "transaction_date_from", the character length must be greater than or equal to 10.')
      end
      ...
      if !@transaction_date_to.nil? && @transaction_date_to.to_s.length < 10
        invalid_properties.push('invalid value for "transaction_date_to", the character length must be greater than or equal to 10.')
      end
    ...
    def due_date_from=(due_date_from)
      ...
      if due_date_from.to_s.length < 10
        fail ArgumentError, 'invalid value for "due_date_from", the character length must be greater than or equal to 10.'
      end
    ...
    def due_date_to=(due_date_to)
      ...
      if due_date_to.to_s.length < 10
        fail ArgumentError, 'invalid value for "due_date_to", the character length must be greater than or equal to 10.'
      end
    ...
    def issue_date_from=(issue_date_from)
      ...
      if issue_date_from.to_s.length < 10
        fail ArgumentError, 'invalid value for "issue_date_from", the character length must be greater than or equal to 10.'
      end
    ...
    def issue_date_to=(issue_date_to)
      ...
      if issue_date_to.to_s.length < 10
        fail ArgumentError, 'invalid value for "issue_date_to", the character length must be greater than or equal to 10.'
      end
    ...
    def created_from=(created_from)
      ...
      if created_from.to_s.length < 10
        fail ArgumentError, 'invalid value for "created_from", the character length must be greater than or equal to 10.'
      end
    ...
    def created_to=(created_to)
      ...
      if created_to.to_s.length < 10
        fail ArgumentError, 'invalid value for "created_to", the character length must be greater than or equal to 10.'
      end
    ...
    def invoice_number=(invoice_number)
      ...
      if invoice_number.to_s.length < 1
        fail ArgumentError, 'invalid value for "invoice_number", the character length must be greater than or equal to 1.'
      end
    ...
    def lines_date_from=(lines_date_from)
      ...
      if lines_date_from.to_s.length < 10
        fail ArgumentError, 'invalid value for "lines_date_from", the character length must be greater than or equal to 10.'
      end
    ...
    def lines_date_to=(lines_date_to)
      ...
      if lines_date_to.to_s.length < 10
        fail ArgumentError, 'invalid value for "lines_date_to", the character length must be greater than or equal to 10.'
      end
    ...
    def transaction_date_from=(transaction_date_from)
      ...
      if transaction_date_from.to_s.length < 10
        fail ArgumentError, 'invalid value for "transaction_date_from", the character length must be greater than or equal to 10.'
      end
    ...
    def transaction_date_to=(transaction_date_to)
      ...
      if transaction_date_to.to_s.length < 10
        fail ArgumentError, 'invalid value for "transaction_date_to", the character length must be greater than or equal to 10.'
      end
    ...
    def hash
      [status, keyword, due_date_from, due_date_to, issue_date_from, issue_date_to, total_amount_max, total_amount_min, created_from, created_to, customer_id, customer_name, invoice_number, lines_date_from, lines_date_to, transaction_date_from, transaction_date_to, is_uncollectible].hash
    end
