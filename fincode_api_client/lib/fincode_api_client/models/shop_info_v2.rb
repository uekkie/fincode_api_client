...
module FincodeApiClient
  class ShopInfoV2 < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::ShopInfoV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @shop_name_en.to_s.length > 25
    ...
    def valid?
      ...
      return false if @shop_name_en.to_s.length > 25
    ...
    # Custom attribute writer method with validation
    # @param [Object] use_of_fincode Value to be assigned
    def use_of_fincode=(use_of_fincode)
      if use_of_fincode.nil?
        fail ArgumentError, 'use_of_fincode cannot be nil'
      end
    ...
    def provides=(provides)
      if provides.nil?
        fail ArgumentError, 'provides cannot be nil'
      end
