...
module FincodeApiClient
  class PaymentCardExecutingResponse
    ...
    def hash
      [shop_id, id, access_id, amount, tax, total_amount, client_field_1, client_field_2, client_field_3, process_date, customer_id, customer_group_id, error_code, created, updated, pay_type, job_code, status, card_id, brand, card_no, expire, holder_name, card_no_hash, method, pay_times, bulk_payment_id, subscription_id, tds_type, tds2_type, tds2_ret_url, return_url, return_url_on_failure, tds2_status, merchant_name, forward, issuer, transaction_id, approve, auth_max_date, item_code, send_url, acs, acs_url, redirect_url].hash
    end
