...
module FincodeApiClient
  class PaymentCardExecutingResponse < ApiModelBase
    # ショップID 
    ...
    # 一括決済ID\\ この決済情報が一括決済機能を用いて登録されたものである場合、このフィールドに一括決済IDが設定されます。 
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::PaymentCardExecutingResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PaymentCardExecutingResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@expire.nil? && @expire.to_s.length < 4
        invalid_properties.push('invalid value for "expire", the character length must be greater than or equal to 4.')
      end
      ...
      if !@holder_name.nil? && @holder_name.to_s.length < 1
        invalid_properties.push('invalid value for "holder_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@card_no_hash.nil? && @card_no_hash.to_s.length < 1
        invalid_properties.push('invalid value for "card_no_hash", the character length must be greater than or equal to 1.')
      end
      ...
      if !@bulk_payment_id.nil? && @bulk_payment_id.to_s.length < 25
        invalid_properties.push('invalid value for "bulk_payment_id", the character length must be greater than or equal to 25.')
      end
      ...
      if !@subscription_id.nil? && @subscription_id.to_s.length < 1
        invalid_properties.push('invalid value for "subscription_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@payment_method_id.nil? && @payment_method_id.to_s.length < 25
        invalid_properties.push('invalid value for "payment_method_id", the character length must be greater than or equal to 25.')
      end
      ...
      if !@forward.nil? && @forward.to_s.length < 1
        invalid_properties.push('invalid value for "forward", the character length must be greater than or equal to 1.')
      end
      ...
      if !@transaction_id.nil? && @transaction_id.to_s.length < 28
        invalid_properties.push('invalid value for "transaction_id", the character length must be greater than or equal to 28.')
      end
      ...
      if !@approve.nil? && @approve.to_s.length < 1
        invalid_properties.push('invalid value for "approve", the character length must be greater than or equal to 1.')
      end
      ...
      if !@acs.nil? && @acs.to_s.length < 1
        invalid_properties.push('invalid value for "acs", the character length must be greater than or equal to 1.')
      end
    ...
    def expire=(expire)
      ...
      if !expire.nil? && expire.to_s.length < 4
        fail ArgumentError, 'invalid value for "expire", the character length must be greater than or equal to 4.'
      end
    ...
    def holder_name=(holder_name)
      ...
      if !holder_name.nil? && holder_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "holder_name", the character length must be greater than or equal to 1.'
      end
    ...
    def card_no_hash=(card_no_hash)
      ...
      if !card_no_hash.nil? && card_no_hash.to_s.length < 1
        fail ArgumentError, 'invalid value for "card_no_hash", the character length must be greater than or equal to 1.'
      end
    ...
    def bulk_payment_id=(bulk_payment_id)
      ...
      if !bulk_payment_id.nil? && bulk_payment_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "bulk_payment_id", the character length must be greater than or equal to 25.'
      end
    ...
    def subscription_id=(subscription_id)
      ...
      if !subscription_id.nil? && subscription_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "subscription_id", the character length must be greater than or equal to 1.'
      end
    ...
    def payment_method_id=(payment_method_id)
      ...
      if !payment_method_id.nil? && payment_method_id.to_s.length < 25
        fail ArgumentError, 'invalid value for "payment_method_id", the character length must be greater than or equal to 25.'
      end
    ...
    def forward=(forward)
      ...
      if !forward.nil? && forward.to_s.length < 1
        fail ArgumentError, 'invalid value for "forward", the character length must be greater than or equal to 1.'
      end
    ...
    def transaction_id=(transaction_id)
      ...
      if !transaction_id.nil? && transaction_id.to_s.length < 28
        fail ArgumentError, 'invalid value for "transaction_id", the character length must be greater than or equal to 28.'
      end
    ...
    def approve=(approve)
      ...
      if !approve.nil? && approve.to_s.length < 1
        fail ArgumentError, 'invalid value for "approve", the character length must be greater than or equal to 1.'
      end
    ...
    def acs=(acs)
      ...
      if !acs.nil? && acs.to_s.length < 1
        fail ArgumentError, 'invalid value for "acs", the character length must be greater than or equal to 1.'
      end
    ...
    def hash
      [shop_id, id, access_id, amount, tax, total_amount, client_field_1, client_field_2, client_field_3, process_date, customer_id, customer_group_id, error_code, created, updated, pay_type, job_code, status, card_id, brand, card_no, expire, holder_name, card_no_hash, method, pay_times, bulk_payment_id, subscription_id, bill_id, payment_method_id, tds_type, tds2_type, tds2_ret_url, return_url, return_url_on_failure, tds2_status, merchant_name, forward, issuer, transaction_id, approve, auth_max_date, item_code, send_url, acs, acs_url, redirect_url].hash
    end
