...
module FincodeApiClient
  ...
  class Directdebit < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::Directdebit` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::Directdebit`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@bank_type.nil? && @bank_type.to_s.length < 1
        invalid_properties.push('invalid value for "bank_type", the character length must be greater than or equal to 1.')
      end
      ...
      if !@account_type.nil? && @account_type.to_s.length < 1
        invalid_properties.push('invalid value for "account_type", the character length must be greater than or equal to 1.')
      end
      ...
      if !@account_name_kana.nil? && @account_name_kana.to_s.length < 1
        invalid_properties.push('invalid value for "account_name_kana", the character length must be greater than or equal to 1.')
      end
    ...
    def account_name_kana=(account_name_kana)
      ...
      if !account_name_kana.nil? && account_name_kana.to_s.length < 1
        fail ArgumentError, 'invalid value for "account_name_kana", the character length must be greater than or equal to 1.'
      end
