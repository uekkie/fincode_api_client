...
module FincodeApiClient
  class AccountRetrievingResponse
    ...
    def hash
      [id, account_id, shop_id, deposit_amount, deposit_date, scheduled_deposit_date, aggregate_term_start, aggregate_term_end, payment_deadline, payment_completion_date, status_code, count, settlement_amount, bank_transfer_fee, total_amount, fee_amount, web_registration_fee_amount, tax_amount, platform_fee_amount, platform_fee_tax_amount, platform_web_registration_fee_amount, created, updated, deposit_destination].hash
    end
