...
module FincodeApiClient
  class User
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::User`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@default_shop_id.nil? && @default_shop_id.to_s.length < 13
        invalid_properties.push('invalid value for "default_shop_id", the character length must be greater than or equal to 13.')
      end
    ...
    def default_shop_id=(default_shop_id)
      ...
      if default_shop_id.to_s.length < 13
        fail ArgumentError, 'invalid value for "default_shop_id", the character length must be greater than or equal to 13.'
      end
