...
module FincodeApiClient
  class DepositTargetBankAccountInfo < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::DepositTargetBankAccountInfo`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@recipient_corporate_name.nil? && @recipient_corporate_name.to_s.length < 1
        invalid_properties.push('invalid value for "recipient_corporate_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@recipient_represntative_last_name.nil? && @recipient_represntative_last_name.to_s.length < 1
        invalid_properties.push('invalid value for "recipient_represntative_last_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@recipient_represntative_first_name.nil? && @recipient_represntative_first_name.to_s.length < 1
        invalid_properties.push('invalid value for "recipient_represntative_first_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@bank_code.nil? && @bank_code.to_s.length < 1
        invalid_properties.push('invalid value for "bank_code", the character length must be greater than or equal to 1.')
      end
      ...
      if !@bank_name_kana.nil? && @bank_name_kana.to_s.length < 1
        invalid_properties.push('invalid value for "bank_name_kana", the character length must be greater than or equal to 1.')
      end
      ...
      if !@branch_code.nil? && @branch_code.to_s.length < 1
        invalid_properties.push('invalid value for "branch_code", the character length must be greater than or equal to 1.')
      end
      ...
      if !@branch_name_kana.nil? && @branch_name_kana.to_s.length < 1
        invalid_properties.push('invalid value for "branch_name_kana", the character length must be greater than or equal to 1.')
      end
      ...
      if !@account_name.nil? && @account_name.to_s.length < 1
        invalid_properties.push('invalid value for "account_name", the character length must be greater than or equal to 1.')
      end
    ...
    def recipient_corporate_name=(recipient_corporate_name)
      ...
      if recipient_corporate_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "recipient_corporate_name", the character length must be greater than or equal to 1.'
      end
    ...
    def recipient_represntative_last_name=(recipient_represntative_last_name)
      ...
      if recipient_represntative_last_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "recipient_represntative_last_name", the character length must be greater than or equal to 1.'
      end
    ...
    def recipient_represntative_first_name=(recipient_represntative_first_name)
      ...
      if recipient_represntative_first_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "recipient_represntative_first_name", the character length must be greater than or equal to 1.'
      end
    ...
    def bank_code=(bank_code)
      ...
      if bank_code.to_s.length < 1
        fail ArgumentError, 'invalid value for "bank_code", the character length must be greater than or equal to 1.'
      end
    ...
    def bank_name_kana=(bank_name_kana)
      ...
      if bank_name_kana.to_s.length < 1
        fail ArgumentError, 'invalid value for "bank_name_kana", the character length must be greater than or equal to 1.'
      end
    ...
    def branch_code=(branch_code)
      ...
      if branch_code.to_s.length < 1
        fail ArgumentError, 'invalid value for "branch_code", the character length must be greater than or equal to 1.'
      end
    ...
    def branch_name_kana=(branch_name_kana)
      ...
      if branch_name_kana.to_s.length < 1
        fail ArgumentError, 'invalid value for "branch_name_kana", the character length must be greater than or equal to 1.'
      end
    ...
    def account_name=(account_name)
      ...
      if account_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "account_name", the character length must be greater than or equal to 1.'
      end
