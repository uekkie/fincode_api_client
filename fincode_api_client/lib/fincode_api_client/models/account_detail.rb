...
module FincodeApiClient
  class AccountDetail
    ...
    def hash
      [detail_id, shop_id, trade_type, payment_method, account_id, order_id, access_id, deposit_amount, amount, tax, fee_total, fee_total_taxin, fee_profit_tax, fee_profit, fee_cost, fee_rate_total, fixed_fee, apply_type, web_registration_fee, web_registration_fee_taxin, web_registration_fee_tax, platform_fee, platform_fee_taxin, platform_fee_rate, fixed_fee_for_platform_fee, apply_type_for_platform_fee, platform_web_registration_fee, platform_web_registration_fee_taxin, platform_web_registration_fee_tax, processed_date, aggregate_term_start, aggregate_term_end, created, updated].hash
    end
