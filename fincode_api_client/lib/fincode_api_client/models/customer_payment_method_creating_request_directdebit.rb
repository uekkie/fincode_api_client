...
module FincodeApiClient
  ...
  class CustomerPaymentMethodCreatingRequestDirectdebit < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::CustomerPaymentMethodCreatingRequestDirectdebit`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] application_type Value to be assigned
    def application_type=(application_type)
      if application_type.nil?
        fail ArgumentError, 'application_type cannot be nil'
      end
