...
module FincodeApiClient
  class PaymentSessionCreatingResponse < ApiModelBase
    # リダイレクト型決済URL ID 
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'virtualaccount' => :'PaymentSessionVirtualAccount',
        :'created' => :'String',
        :'updated' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PaymentSessionCreatingResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, link_url, success_url, cancel_url, status, expire, shop_service_name, guide_mail_send_flag, receiver_mail, mail_customer_name, thanks_mail_send_flag, shop_mail_template_id, transaction, card, konbini, paypay, virtualaccount, created, updated].hash
    end
