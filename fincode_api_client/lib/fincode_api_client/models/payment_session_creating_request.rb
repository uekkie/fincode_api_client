...
module FincodeApiClient
  class PaymentSessionCreatingRequest
    ...
    # リダイレクト型決済URL 有効期限\\ 形式： `yyyy/MM/dd HH.MM.SS.SSS`  - デフォルト： URL発行時点から24時間 - 最長： 30日 - 最短： 5分 
    ...
    def hash
      [transaction, card, konbini, paypay, success_url, cancel_url, expire, shop_service_name, guide_mail_send_flag, receiver_mail, mail_customer_name, thanks_mail_send_flag, shop_mail_template_id].hash
    end
