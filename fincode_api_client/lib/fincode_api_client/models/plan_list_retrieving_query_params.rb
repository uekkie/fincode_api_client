...
module FincodeApiClient
  class PlanListRetrievingQueryParams < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PlanListRetrievingQueryParams`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@plan_name.nil? && @plan_name.to_s.length < 1
        invalid_properties.push('invalid value for "plan_name", the character length must be greater than or equal to 1.')
      end
      ...
      if !@delete_flag.nil? && @delete_flag.to_s.length < 1
        invalid_properties.push('invalid value for "delete_flag", the character length must be greater than or equal to 1.')
      end
    ...
    def plan_name=(plan_name)
      ...
      if !plan_name.nil? && plan_name.to_s.length < 1
        fail ArgumentError, 'invalid value for "plan_name", the character length must be greater than or equal to 1.'
      end
