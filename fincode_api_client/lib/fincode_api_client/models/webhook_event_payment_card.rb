...
module FincodeApiClient
  class WebhookEventPaymentCard
    ...
    def hash
      [shop_id, order_id, access_id, pay_type, status, customer_id, method, client_field_1, client_field_2, client_field_3, amount, tax, currency, job_code, subscription_id, bulk_payment_id, forward, transaction_id, transaction_date, approve, error_code, event].hash
    end
