...
module FincodeApiClient
  class AccountListItem < ApiModelBase
    # 売上入金ID 
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::AccountListItem`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, account_id, shop_id, scheduled_deposit_date, aggregate_term_start, aggregate_term_end, deposit_date, payment_deadline, payment_completion_date, status_code, count, bank_transfer_fee, total_amount, fee_amount, deposit_amount, platform_fee_amount, platform_fee_tax_amount, created, updated].hash
    end
