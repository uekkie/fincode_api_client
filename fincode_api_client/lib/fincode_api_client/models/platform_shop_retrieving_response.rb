...
module FincodeApiClient
  class PlatformShopRetrievingResponse
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::PlatformShopRetrievingResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@shared_customer_flag.nil? && @shared_customer_flag.to_s.length < 1
        invalid_properties.push('invalid value for "shared_customer_flag", the character length must be great than or equal to 1.')
      end
      ...
      if !@api_key_display_flag.nil? && @api_key_display_flag.to_s.length < 1
        invalid_properties.push('invalid value for "api_key_display_flag", the character length must be great than or equal to 1.')
      end
