...
module FincodeApiClient
  class SubscriptionCreatingRequest < ApiModelBase
    # サブスクリプションID 
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::SubscriptionCreatingRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @plan_id.to_s.length < 1
        invalid_properties.push('invalid value for "plan_id", the character length must be greater than or equal to 1.')
      end
      ...
      if !@initial_amount.nil? && @initial_amount.to_s.length < 1
        invalid_properties.push('invalid value for "initial_amount", the character length must be greater than or equal to 1.')
      end
      ...
      if !@initial_tax.nil? && @initial_tax.to_s.length < 1
        invalid_properties.push('invalid value for "initial_tax", the character length must be greater than or equal to 1.')
      end
    ...
    def plan_id=(plan_id)
      ...
      if plan_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "plan_id", the character length must be greater than or equal to 1.'
      end
    ...
    def initial_amount=(initial_amount)
      ...
      if initial_amount.to_s.length < 1
        fail ArgumentError, 'invalid value for "initial_amount", the character length must be greater than or equal to 1.'
      end
    ...
    def initial_tax=(initial_tax)
      ...
      if initial_tax.to_s.length < 1
        fail ArgumentError, 'invalid value for "initial_tax", the character length must be greater than or equal to 1.'
      end
