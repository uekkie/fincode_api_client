...
module FincodeApiClient
  class WebhookEventSubscriptionCard < ApiModelBase
    # ショップID 
    ...
    attr_accessor :default_card_flag
    ...
    def self.attribute_map
      {
        ...
        :'card_id' => :'card_id',
        :'default_card_flag' => :'default_card_flag',
        :'status' => :'status',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `FincodeApiClient::WebhookEventSubscriptionCard` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `FincodeApiClient::WebhookEventSubscriptionCard`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'default_card_flag')
        self.default_card_flag = attributes[:'default_card_flag']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          card_id == o.card_id &&
          default_card_flag == o.default_card_flag &&
          status == o.status &&
    ...
    def hash
      [shop_id, subscription_id, plan_id, customer_id, card_id, default_card_flag, status, client_field_1, client_field_2, client_field_3, process_date, start_date, stop_date, next_charge_date, end_month_flag, pay_type, event].hash
    end
