...
module FincodeApiClient
  class WebhookApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [WebhookEventPaymentGooglePay] :webhook_event_payment_google_pay 
    # @return [WebhookResponse]
    def receive_webhook_of_google_pay_payment(opts = {})
      data, _status_code, _headers = receive_webhook_of_google_pay_payment_with_http_info(opts)
      data
    end
    ...
    # @option opts [WebhookEventPaymentGooglePay] :webhook_event_payment_google_pay 
    # @return [Array<(WebhookResponse, Integer, Hash)>] WebhookResponse data, response status code and response headers
    def receive_webhook_of_google_pay_payment_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhookApi.receive_webhook_of_google_pay_payment ...'
      end
      # resource path
      local_var_path = '/your-endpoint-on-googlepay-payment'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'webhook_event_payment_google_pay'])
      ...
      new_options = opts.merge(
        :operation => :"WebhookApi.receive_webhook_of_google_pay_payment",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhookApi#receive_webhook_of_google_pay_payment\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
