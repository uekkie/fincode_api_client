...
module FincodeApiClient
  class DefaultApi
    ...
    # @option opts [AuthorizePaymentRequest] :authorize_payment_request 
    # @return [AuthorizePayment200Response]
    ...
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした決済のうち、&#x60;id&#x60;で指定した決済のオーソリを再度実行します。 
    # @option opts [AuthorizePaymentRequest] :authorize_payment_request 
    # @return [Array<(AuthorizePayment200Response, Integer, Hash)>] AuthorizePayment200Response data, response status code and response headers
    def authorize_payment_with_http_info(id, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'authorize_payment_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'AuthorizePayment200Response'
    ...
    # @param id [String] インボイスID 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書のキャンセルができます。 
    # @return [InvoiceDetailCancelingResponse]
    def cancel_invoices(id, opts = {})
      data, _status_code, _headers = cancel_invoices_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書のキャンセルができます。 
    # @return [Array<(InvoiceDetailCancelingResponse, Integer, Hash)>] InvoiceDetailCancelingResponse data, response status code and response headers
    def cancel_invoices_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.cancel_invoices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.cancel_invoices"
      end
      # resource path
      local_var_path = '/v1/invoices/{id}/cancel'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceDetailCancelingResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.cancel_invoices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#cancel_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_customer_payment_method(customer_id, id, pay_type, opts = {})
      data, _status_code, _headers = delete_customer_payment_method_with_http_info(customer_id, id, pay_type, opts)
      data
    end
    ...
    def delete_customer_payment_method_with_http_info(customer_id, id, pay_type, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'pay_type' is set
      if @api_client.config.client_side_validation && pay_type.nil?
        fail ArgumentError, "Missing the required parameter 'pay_type' when calling DefaultApi.delete_customer_payment_method"
      end
      # resource path
    ...
    # @param id [String] インボイスID 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を削除します。 
    # @return [InvoiceDetailDeletingResponse]
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を削除します。 
    # @return [Array<(InvoiceDetailDeletingResponse, Integer, Hash)>] InvoiceDetailDeletingResponse data, response status code and response headers
    def delete_invoices_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.delete_invoices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.delete_invoices"
      end
      # resource path
      local_var_path = '/v1/invoices/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceDetailDeletingResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.delete_invoices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#delete_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] インボイスID 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定することで、指定したテナントショップのインボイス請求書情報を取得できます。 
    # @return [InvoiceDetailRetrievingResponse]
    def get_invoices(id, opts = {})
      data, _status_code, _headers = get_invoices_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定することで、指定したテナントショップのインボイス請求書情報を取得できます。 
    # @return [Array<(InvoiceDetailRetrievingResponse, Integer, Hash)>] InvoiceDetailRetrievingResponse data, response status code and response headers
    def get_invoices_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.get_invoices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.get_invoices"
      end
      # resource path
      local_var_path = '/v1/invoices/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceDetailRetrievingResponse'
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#get_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元とした請求書情報を一覧で取得します。 
    # @option opts [GetInvoicesListQueryParameter] :query 検索条件クエリパラメータ 
    # @return [InvoiceListRetrievingResponse]
    def get_invoices_list(opts = {})
      data, _status_code, _headers = get_invoices_list_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元とした請求書情報を一覧で取得します。 
    # @option opts [GetInvoicesListQueryParameter] :query 検索条件クエリパラメータ 
    # @return [Array<(InvoiceListRetrievingResponse, Integer, Hash)>] InvoiceListRetrievingResponse data, response status code and response headers
    def get_invoices_list_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.get_invoices_list ...'
      end
      # resource path
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceListRetrievingResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.get_invoices_list",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#get_invoices_list\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] インボイスID 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書の請求を実施します。 
    # @option opts [InvoiceDetailOpeningRequest] :invoice_detail_opening_request 
    # @return [InvoiceDetailOpeningResponse]
    def open_invoices(id, opts = {})
      data, _status_code, _headers = open_invoices_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書の請求を実施します。 
    # @option opts [InvoiceDetailOpeningRequest] :invoice_detail_opening_request 
    # @return [Array<(InvoiceDetailOpeningResponse, Integer, Hash)>] InvoiceDetailOpeningResponse data, response status code and response headers
    def open_invoices_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.open_invoices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.open_invoices"
      end
      # resource path
      local_var_path = '/v1/invoices/{id}/open'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'invoice_detail_opening_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceDetailOpeningResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.open_invoices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#open_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] インボイスID 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書についての更新ができます。 
    # @option opts [PaidExternallyInvoicesRequest] :paid_externally_invoices_request 
    # @return [InvoiceDetailMarkingResponse]
    def paid_externally_invoices(id, opts = {})
      data, _status_code, _headers = paid_externally_invoices_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元としたインボイス請求書についての更新ができます。 
    # @option opts [PaidExternallyInvoicesRequest] :paid_externally_invoices_request 
    # @return [Array<(InvoiceDetailMarkingResponse, Integer, Hash)>] InvoiceDetailMarkingResponse data, response status code and response headers
    def paid_externally_invoices_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.paid_externally_invoices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.paid_externally_invoices"
      end
      # resource path
      local_var_path = '/v1/invoices/{id}/paid_externally'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'paid_externally_invoices_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceDetailMarkingResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.paid_externally_invoices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#paid_externally_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param id [String] インボイスID
    # @param [Hash] opts the optional parameters
    # @return [InvoiceDetailRefreshResponse]
    def refresh_invoices_virtualaccount(id, opts = {})
      data, _status_code, _headers = refresh_invoices_virtualaccount_with_http_info(id, opts)
      data
    end
    ...
    # @param id [String] インボイスID
    # @param [Hash] opts the optional parameters
    # @return [Array<(InvoiceDetailRefreshResponse, Integer, Hash)>] InvoiceDetailRefreshResponse data, response status code and response headers
    def refresh_invoices_virtualaccount_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.refresh_invoices_virtualaccount ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.refresh_invoices_virtualaccount"
      end
      if @api_client.config.client_side_validation && id.to_s.length > 30
        fail ArgumentError, 'invalid value for "id" when calling DefaultApi.refresh_invoices_virtualaccount, the character length must be smaller than or equal to 30.'
      end

      if @api_client.config.client_side_validation && id.to_s.length < 1
        fail ArgumentError, 'invalid value for "id" when calling DefaultApi.refresh_invoices_virtualaccount, the character length must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = '/v1/invoices/{id}/virtual_account/refresh'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceDetailRefreshResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.refresh_invoices_virtualaccount",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#refresh_invoices_virtualaccount\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元とした請求書情報を作成します。 
    # @option opts [InvoiceCreatingRequest] :invoice_creating_request 
    # @return [InvoiceCreatingResponse]
    def register_invoices(opts = {})
      data, _status_code, _headers = register_invoices_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを請求元とした請求書情報を作成します。 
    # @option opts [InvoiceCreatingRequest] :invoice_creating_request 
    # @return [Array<(InvoiceCreatingResponse, Integer, Hash)>] InvoiceCreatingResponse data, response status code and response headers
    def register_invoices_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.register_invoices ...'
      end
      # resource path
      local_var_path = '/v1/invoices'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'invoice_creating_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceCreatingResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.register_invoices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#register_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param shop_id [String] ショップID 
    # @param enable_immediate_use [Boolean] VISA/Mastercard即時利用をリクエストするかどうか  - &#x60;true&#x60;： 即時利用をリクエストする - &#x60;false&#x60;： 即時利用をリクエストしない  即時利用は以下の場合リクエストできません。  - &#x60;本番環境申請情報.contract_info.site_published&#x60;が&#x60;true&#x60;でない（審査時点でWebサイトが用意されていない） - &#x60;本番環境申請情報.shop_info.deals_long_apply_content&#x60;が&#x60;true&#x60;である（審査に時間がかかる商材を取り扱うと表明している） 
    # @param [Hash] opts the optional parameters
    # @return [POSTContractsExaminationsResponse]
    def request_production_environment(tenant_shop_id, shop_id, enable_immediate_use, opts = {})
      data, _status_code, _headers = request_production_environment_with_http_info(tenant_shop_id, shop_id, enable_immediate_use, opts)
      data
    end
    ...
    def request_production_environment_with_http_info(tenant_shop_id, shop_id, enable_immediate_use, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && shop_id.nil?
        fail ArgumentError, "Missing the required parameter 'shop_id' when calling DefaultApi.request_production_environment"
      end
      # verify the required parameter 'enable_immediate_use' is set
      if @api_client.config.client_side_validation && enable_immediate_use.nil?
        fail ArgumentError, "Missing the required parameter 'enable_immediate_use' when calling DefaultApi.request_production_environment"
      end
      # resource path
      ...
      # form parameters
      form_params = opts[:form_params] || {}
      form_params['shop_id'] = shop_id
      form_params['enable_immediate_use'] = enable_immediate_use
    ...
    # @param id [String] インボイスID 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を更新します。 
    # @option opts [InvoiceDetailUpdatingRequest] :invoice_detail_updating_request 
    # @return [InvoiceDetailUpdatingResponse]
    def update_invoices(id, opts = {})
      data, _status_code, _headers = update_invoices_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :tenant_shop_id &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップを販売主とした請求書情報を更新します。 
    # @option opts [InvoiceDetailUpdatingRequest] :invoice_detail_updating_request 
    # @return [Array<(InvoiceDetailUpdatingResponse, Integer, Hash)>] InvoiceDetailUpdatingResponse data, response status code and response headers
    def update_invoices_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.update_invoices ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling DefaultApi.update_invoices"
      end
      # resource path
      local_var_path = '/v1/invoices/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'invoice_detail_updating_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceDetailUpdatingResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Secret-Bearer-Auth', 'Secret-Basic-Auth']

      new_options = opts.merge(
        :operation => :"DefaultApi.update_invoices",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DefaultApi#update_invoices\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param tenant_shop_id [String] &lt;span class&#x3D;\&quot;smallText color--red-400\&quot;&gt;※ プラットフォームのメインショップのみ指定可&lt;/span&gt;\\ テナントショップID。\\ 指定したテナントショップのものとしてファイルをアップロードします。 
    # @param type [ExaminationFileType] 
    # @param data [Object] 審査ファイルデータ\\\\ \\\\ 画像ファイルをマルチパートアップロードするときはこの&#x60;data&#x60;フィールドに画像データを設定します。 
    # @param [Hash] opts the optional parameters
    # @return [ExaminationFileUploadingResponse]
    def upload_examination_file(id, tenant_shop_id, type, data, opts = {})
      data, _status_code, _headers = upload_examination_file_with_http_info(id, tenant_shop_id, type, data, opts)
      data
    end
    ...
    def upload_examination_file_with_http_info(id, tenant_shop_id, type, data, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && type.nil?
        fail ArgumentError, "Missing the required parameter 'type' when calling DefaultApi.upload_examination_file"
      end
      # resource path
