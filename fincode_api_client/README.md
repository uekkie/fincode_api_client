...
```shell
gem install ./fincode_api_client-1.4.1.gem
```

(for development, run `gem install --dev ./fincode_api_client-1.4.1.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'fincode_api_client', '~> 1.4.1'
...
## Documentation for Models
 ...
 - [FincodeApiClient::GetInvoicesListQueryParameter](docs/GetInvoicesListQueryParameter.md)
