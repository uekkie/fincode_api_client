...
# Unit tests for FincodeApiClient::WebhookEventSubscriptionDirectDebit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::WebhookEventSubscriptionDirectDebit do
  let(:instance) { FincodeApiClient::WebhookEventSubscriptionDirectDebit.new }

  describe 'test an instance of WebhookEventSubscriptionDirectDebit' do
    it 'should create an instance of WebhookEventSubscriptionDirectDebit' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::WebhookEventSubscriptionDirectDebit)
    end
  end
