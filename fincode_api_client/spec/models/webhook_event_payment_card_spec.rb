...
# Unit tests for FincodeApiClient::WebhookEventPaymentCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::WebhookEventPaymentCard do
  let(:instance) { FincodeApiClient::WebhookEventPaymentCard.new }

  describe 'test an instance of WebhookEventPaymentCard' do
    it 'should create an instance of WebhookEventPaymentCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::WebhookEventPaymentCard)
    end
  end
