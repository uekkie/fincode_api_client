...
# Unit tests for FincodeApiClient::PaymentDirectDebitRetrievingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::PaymentDirectDebitRetrievingResponse do
  let(:instance) { FincodeApiClient::PaymentDirectDebitRetrievingResponse.new }

  describe 'test an instance of PaymentDirectDebitRetrievingResponse' do
    it 'should create an instance of PaymentDirectDebitRetrievingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::PaymentDirectDebitRetrievingResponse)
    end
  end
