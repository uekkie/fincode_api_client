...
# Unit tests for FincodeApiClient::PaymentDirectDebitChangingAmountResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::PaymentDirectDebitChangingAmountResponse do
  let(:instance) { FincodeApiClient::PaymentDirectDebitChangingAmountResponse.new }

  describe 'test an instance of PaymentDirectDebitChangingAmountResponse' do
    it 'should create an instance of PaymentDirectDebitChangingAmountResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::PaymentDirectDebitChangingAmountResponse)
    end
  end
