...
# Unit tests for FincodeApiClient::SubscriptionCreatingRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::SubscriptionCreatingRequest do
  let(:instance) { FincodeApiClient::SubscriptionCreatingRequest.new }

  describe 'test an instance of SubscriptionCreatingRequest' do
    it 'should create an instance of SubscriptionCreatingRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::SubscriptionCreatingRequest)
    end
  end
