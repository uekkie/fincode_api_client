...
# Unit tests for FincodeApiClient::CustomerPaymentMethodCreatingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::CustomerPaymentMethodCreatingResponse do
  let(:instance) { FincodeApiClient::CustomerPaymentMethodCreatingResponse.new }

  describe 'test an instance of CustomerPaymentMethodCreatingResponse' do
    it 'should create an instance of CustomerPaymentMethodCreatingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::CustomerPaymentMethodCreatingResponse)
    end
  end
