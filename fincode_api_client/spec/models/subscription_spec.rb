...
# Unit tests for FincodeApiClient::Subscription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::Subscription do
  let(:instance) { FincodeApiClient::Subscription.new }

  describe 'test an instance of Subscription' do
    it 'should create an instance of Subscription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::Subscription)
    end
  end
