...
# Unit tests for FincodeApiClient::PaymentDirectDebitExecutingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::PaymentDirectDebitExecutingResponse do
  let(:instance) { FincodeApiClient::PaymentDirectDebitExecutingResponse.new }

  describe 'test an instance of PaymentDirectDebitExecutingResponse' do
    it 'should create an instance of PaymentDirectDebitExecutingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::PaymentDirectDebitExecutingResponse)
    end
  end
