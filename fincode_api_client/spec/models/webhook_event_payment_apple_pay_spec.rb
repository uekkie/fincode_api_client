...
# Unit tests for FincodeApiClient::WebhookEventPaymentApplePay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::WebhookEventPaymentApplePay do
  let(:instance) { FincodeApiClient::WebhookEventPaymentApplePay.new }

  describe 'test an instance of WebhookEventPaymentApplePay' do
    it 'should create an instance of WebhookEventPaymentApplePay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::WebhookEventPaymentApplePay)
    end
  end
