...
# Unit tests for FincodeApiClient::SubscriptionUnsubscribingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::SubscriptionUnsubscribingResponse do
  let(:instance) { FincodeApiClient::SubscriptionUnsubscribingResponse.new }

  describe 'test an instance of SubscriptionUnsubscribingResponse' do
    it 'should create an instance of SubscriptionUnsubscribingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::SubscriptionUnsubscribingResponse)
    end
  end
  ...
  describe 'test attribute "initial_total_amount"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "end_month_flag"' do
    it 'should work' do
      ...
      #   expect { instance.end_month_flag = value }.not_to raise_error
      # end
    end
  end
