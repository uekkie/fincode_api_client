...
# Unit tests for FincodeApiClient::SubscriptionUpdatingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::SubscriptionUpdatingResponse do
  let(:instance) { FincodeApiClient::SubscriptionUpdatingResponse.new }

  describe 'test an instance of SubscriptionUpdatingResponse' do
    it 'should create an instance of SubscriptionUpdatingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::SubscriptionUpdatingResponse)
    end
  end
