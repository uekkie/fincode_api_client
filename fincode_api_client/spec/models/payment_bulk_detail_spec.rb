...
# Unit tests for FincodeApiClient::PaymentBulkDetail
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::PaymentBulkDetail do
  let(:instance) { FincodeApiClient::PaymentBulkDetail.new }

  describe 'test an instance of PaymentBulkDetail' do
    it 'should create an instance of PaymentBulkDetail' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::PaymentBulkDetail)
    end
  end
