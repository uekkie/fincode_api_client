...
# Unit tests for FincodeApiClient::SubscriptionCreatingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::SubscriptionCreatingResponse do
  let(:instance) { FincodeApiClient::SubscriptionCreatingResponse.new }

  describe 'test an instance of SubscriptionCreatingResponse' do
    it 'should create an instance of SubscriptionCreatingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::SubscriptionCreatingResponse)
    end
  end
