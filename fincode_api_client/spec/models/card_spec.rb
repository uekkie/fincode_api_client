...
# Unit tests for FincodeApiClient::Card
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::Card do
  let(:instance) { FincodeApiClient::Card.new }

  describe 'test an instance of Card' do
    it 'should create an instance of Card' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::Card)
    end
  end
