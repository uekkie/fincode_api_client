...
# Unit tests for FincodeApiClient::WebhookEventPaymentDirectDebit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::WebhookEventPaymentDirectDebit do
  let(:instance) { FincodeApiClient::WebhookEventPaymentDirectDebit.new }

  describe 'test an instance of WebhookEventPaymentDirectDebit' do
    it 'should create an instance of WebhookEventPaymentDirectDebit' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::WebhookEventPaymentDirectDebit)
    end
  end
