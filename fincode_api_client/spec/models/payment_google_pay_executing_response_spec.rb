...
# Unit tests for FincodeApiClient::PaymentGooglePayExecutingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::PaymentGooglePayExecutingResponse do
  let(:instance) { FincodeApiClient::PaymentGooglePayExecutingResponse.new }

  describe 'test an instance of PaymentGooglePayExecutingResponse' do
    it 'should create an instance of PaymentGooglePayExecutingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::PaymentGooglePayExecutingResponse)
    end
  end
