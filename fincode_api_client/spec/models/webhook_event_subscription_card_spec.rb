...
# Unit tests for FincodeApiClient::WebhookEventSubscriptionCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::WebhookEventSubscriptionCard do
  let(:instance) { FincodeApiClient::WebhookEventSubscriptionCard.new }

  describe 'test an instance of WebhookEventSubscriptionCard' do
    it 'should create an instance of WebhookEventSubscriptionCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::WebhookEventSubscriptionCard)
    end
  end
  ...
  describe 'test attribute "default_card_flag"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
