...
# Unit tests for FincodeApiClient::PaymentDirectDebitCancelingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::PaymentDirectDebitCancelingResponse do
  let(:instance) { FincodeApiClient::PaymentDirectDebitCancelingResponse.new }

  describe 'test an instance of PaymentDirectDebitCancelingResponse' do
    it 'should create an instance of PaymentDirectDebitCancelingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::PaymentDirectDebitCancelingResponse)
    end
  end
