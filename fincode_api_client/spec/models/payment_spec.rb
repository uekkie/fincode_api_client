...
# Unit tests for FincodeApiClient::Payment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::Payment do
  let(:instance) { FincodeApiClient::Payment.new }

  describe 'test an instance of Payment' do
    it 'should create an instance of Payment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::Payment)
    end
  end
