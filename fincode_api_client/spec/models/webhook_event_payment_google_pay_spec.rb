...
# Unit tests for FincodeApiClient::WebhookEventPaymentGooglePay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::WebhookEventPaymentGooglePay do
  let(:instance) { FincodeApiClient::WebhookEventPaymentGooglePay.new }

  describe 'test an instance of WebhookEventPaymentGooglePay' do
    it 'should create an instance of WebhookEventPaymentGooglePay' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::WebhookEventPaymentGooglePay)
    end
  end
