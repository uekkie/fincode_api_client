...
# Unit tests for FincodeApiClient::PaymentDirectDebitCreatingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::PaymentDirectDebitCreatingResponse do
  let(:instance) { FincodeApiClient::PaymentDirectDebitCreatingResponse.new }

  describe 'test an instance of PaymentDirectDebitCreatingResponse' do
    it 'should create an instance of PaymentDirectDebitCreatingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::PaymentDirectDebitCreatingResponse)
    end
  end
