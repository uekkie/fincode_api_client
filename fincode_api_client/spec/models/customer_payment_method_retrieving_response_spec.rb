...
# Unit tests for FincodeApiClient::CustomerPaymentMethodRetrievingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::CustomerPaymentMethodRetrievingResponse do
  let(:instance) { FincodeApiClient::CustomerPaymentMethodRetrievingResponse.new }

  describe 'test an instance of CustomerPaymentMethodRetrievingResponse' do
    it 'should create an instance of CustomerPaymentMethodRetrievingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::CustomerPaymentMethodRetrievingResponse)
    end
  end
