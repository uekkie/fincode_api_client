...
# Unit tests for FincodeApiClient::RetrievePaymentListQueryParameterOneOf2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::RetrievePaymentListQueryParameterOneOf2 do
  let(:instance) { FincodeApiClient::RetrievePaymentListQueryParameterOneOf2.new }

  describe 'test an instance of RetrievePaymentListQueryParameterOneOf2' do
    it 'should create an instance of RetrievePaymentListQueryParameterOneOf2' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::RetrievePaymentListQueryParameterOneOf2)
    end
  end
