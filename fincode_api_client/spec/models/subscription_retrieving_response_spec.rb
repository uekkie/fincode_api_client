...
# Unit tests for FincodeApiClient::SubscriptionRetrievingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe FincodeApiClient::SubscriptionRetrievingResponse do
  let(:instance) { FincodeApiClient::SubscriptionRetrievingResponse.new }

  describe 'test an instance of SubscriptionRetrievingResponse' do
    it 'should create an instance of SubscriptionRetrievingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(FincodeApiClient::SubscriptionRetrievingResponse)
    end
  end
